...
VALUES (N'20240704191430_Initial', N'8.0.8');
GO
...
INSERT INTO [__EFMigrationsHistory] ([MigrationId], [ProductVersion])
VALUES (N'20240718201253_AddedRegions', N'8.0.8');
GO
...
INSERT INTO [__EFMigrationsHistory] ([MigrationId], [ProductVersion])
VALUES (N'20240828192223_AddedLocations', N'8.0.8');
GO
...
WHERE [LocationId] = '2ac4032b-240f-4029-9d64-d20848c8d694';
SELECT @@ROWCOUNT;

GO

DELETE FROM [Locations]
WHERE [LocationId] = '6d55a9ed-e128-4366-97d0-eddcb6fa7c58';
SELECT @@ROWCOUNT;

GO

DELETE FROM [Locations]
WHERE [LocationId] = '774e9499-fb15-4995-8dc8-43610a5f5b53';
SELECT @@ROWCOUNT;

GO

DELETE FROM [Regions]
WHERE [RegionId] = '0e817f5c-e063-4d2a-aca5-0e40b52dd0ce';
SELECT @@ROWCOUNT;

GO

DELETE FROM [Regions]
WHERE [RegionId] = '6cc76f4a-5c6d-4f25-b898-0ffeaec0af1f';
SELECT @@ROWCOUNT;

GO

DELETE FROM [Regions]
WHERE [RegionId] = '7d45913f-2062-41e6-8da5-2d9f3b259552';
SELECT @@ROWCOUNT;

GO

DELETE FROM [Regions]
WHERE [RegionId] = 'c5b96f86-2305-4a90-b3cf-cd8300c28017';
SELECT @@ROWCOUNT;

GO

DELETE FROM [Regions]
WHERE [RegionId] = 'cd5aa765-ace1-4cf0-bd8d-141eca83a8e1';
SELECT @@ROWCOUNT;

GO

DELETE FROM [Sites]
WHERE [SiteId] = 'bfde935e-abe4-4d64-9c36-2cfb172fae99';
SELECT @@ROWCOUNT;

GO

DELETE FROM [Sites]
WHERE [SiteId] = 'c9ab9a01-b18f-4fbb-8acd-27359fd52c0d';
SELECT @@ROWCOUNT;

GO

DELETE FROM [Sites]
WHERE [SiteId] = 'cc53d272-23e7-436d-b5a5-c3a235cdb2fd';
SELECT @@ROWCOUNT;

GO

DELETE FROM [Sites]
WHERE [SiteId] = 'e961b53c-e82b-453e-b814-ecddc031e953';
SELECT @@ROWCOUNT;

GO

DELETE FROM [Regions]
WHERE [RegionId] = '04d82d36-3c9a-4b57-94f0-509574eb1523';
SELECT @@ROWCOUNT;

GO

DELETE FROM [Regions]
WHERE [RegionId] = '7736d6df-d93d-42c8-82c3-639bfd7b326f';
SELECT @@ROWCOUNT;
...
IF EXISTS (SELECT * FROM [sys].[identity_columns] WHERE [name] IN (N'LocationId', N'LocationName') AND [object_id] = OBJECT_ID(N'[Locations]'))
    SET IDENTITY_INSERT [Locations] ON;
INSERT INTO [Locations] ([LocationId], [LocationName])
VALUES ('1a86e167-a21c-4467-9beb-1e63b08d371f', N'Kitchen'),
('27efc204-445e-4321-a845-8a72d7f84f71', N'Reception'),
('8aec57a1-4918-4772-aea5-1e0fddd68c6d', N'Dinning room');
IF EXISTS (SELECT * FROM [sys].[identity_columns] WHERE [name] IN (N'LocationId', N'LocationName') AND [object_id] = OBJECT_ID(N'[Locations]'))
    SET IDENTITY_INSERT [Locations] OFF;
GO
...
IF EXISTS (SELECT * FROM [sys].[identity_columns] WHERE [name] IN (N'RegionId', N'RegionName') AND [object_id] = OBJECT_ID(N'[Regions]'))
    SET IDENTITY_INSERT [Regions] ON;
INSERT INTO [Regions] ([RegionId], [RegionName])
VALUES ('030f5eaf-d8c1-4489-b871-737ee8e06ed1', N'Wales'),
('1cc438b5-ffae-4fc2-8045-be779200b829', N'Southern'),
('506ccb78-dac0-4e18-96a1-d014b61c58da', N'South West'),
('5ba01a1e-51f4-49b0-b4f7-512ed3746433', N'Middle England'),
('6b7331db-983b-4724-8a24-12951aab38b6', N'South East'),
('ac2fa921-b9e5-4c44-9795-f60ed999e0c4', N'Northern'),
('fe07a80f-b774-4b15-b496-a8db27a4d5ef', N'Scotland');
IF EXISTS (SELECT * FROM [sys].[identity_columns] WHERE [name] IN (N'RegionId', N'RegionName') AND [object_id] = OBJECT_ID(N'[Regions]'))
    SET IDENTITY_INSERT [Regions] OFF;
GO
...
IF EXISTS (SELECT * FROM [sys].[identity_columns] WHERE [name] IN (N'SiteId', N'RegionId', N'SiteName') AND [object_id] = OBJECT_ID(N'[Sites]'))
    SET IDENTITY_INSERT [Sites] ON;
INSERT INTO [Sites] ([SiteId], [RegionId], [SiteName])
VALUES ('4583d6d5-56ea-4701-8188-2cb29af75ab1', '030f5eaf-d8c1-4489-b871-737ee8e06ed1', N'Cardiff'),
('81b1a919-6e37-4c4f-af7c-76cc4be85811', '030f5eaf-d8c1-4489-b871-737ee8e06ed1', N'Bangor'),
('e915faba-37a8-4dc9-8d03-1b9196edc227', '6b7331db-983b-4724-8a24-12951aab38b6', N'Horsham'),
('ef227e96-c100-42bc-af5b-b08e1d215d64', '6b7331db-983b-4724-8a24-12951aab38b6', N'Brighton');
IF EXISTS (SELECT * FROM [sys].[identity_columns] WHERE [name] IN (N'SiteId', N'RegionId', N'SiteName') AND [object_id] = OBJECT_ID(N'[Sites]'))
    SET IDENTITY_INSERT [Sites] OFF;
GO

INSERT INTO [__EFMigrationsHistory] ([MigrationId], [ProductVersion])
VALUES (N'20241107185118_AddedCheckins', N'8.0.8');
GO
